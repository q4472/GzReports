    ...
    public class F4Model
    {
        ...
        public void LoadSpec(RequestPackage rqp)
        {
            if (rqp != null && rqp.Parameters != null && rqp.Parameters.Length > 0)
            {
                ...
                {
                    DataSet spec = HomeData.Prep.LoadSpec(sessionId, specId, specRowId);
                    if (spec != null)
                    {
        ...
        {
            ResponsePackage rsp = HomeData.Prep.LoadS(rqp);
            return rsp;
        }
        public static ResponsePackage SendEmail(RequestPackage rqp)
        {
            ...
            rqp.Parameters = ps;
            ResponsePackage rsp = HomeData.Prep.SendEmail(rqp);
            return rsp;
        }
    }
}