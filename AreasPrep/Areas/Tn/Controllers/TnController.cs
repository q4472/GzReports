using AreasPrep.Areas.Tn.Models;
...
namespace AreasPrep.Areas.Tn.Controllers
{
    public class TnController : Controller
    {
        ...
        {
            Object result = "AreasPrep.Areas.Tn.Controllers.TnController.Get1cData()";
            RequestPackage rqp = RequestPackage.ParseRequest(Request.InputStream, Request.ContentEncoding);
        ...
        {
            Object result = "AreasPrep.Areas.Tn.Controllers.TnController.GetUData()";
            RequestPackage rqp = RequestPackage.ParseRequest(Request.InputStream, Request.ContentEncoding);
            String fCode = rqp["fCode"] as String;
            Guid sessionId = rqp.SessionId;
            TnModel m = new TnModel();
